...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/29 17:12:09 by akabbaj           #+#    #+#             */
/*   Updated: 2024/06/29 22:28:42 by vbronov          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	solve(char *view_points, char grid[7][7], int row, int col)
{
	char	box;
	int		next_row;
	int		next_col;
